classdef cDB < cMySQL
    ...
    properties
        ...
        AdditionalScripts = {...
            ...
            '\Vessels\UASC data\Scripts\Insert_data.m']
            };
        LoadRaw = true;
    ...
    methods
       ...
       marorkaDir_ch = ['C:\Users\damcl\OneDrive - Hempel Group\Documents\'...
           'SQL\tests\EcoInsight Test Scripts\Marorka'];
    ...
    %                     'C:\Users\damcl\OneDrive - Hempel Group\Documents\Ship Data\Berge Kibo\DNVGL\Raw\1 Operational reporting 2017-03-10 13_58.csv'
       ...
       ddFileEuronav = ['L:\Project\MWB-Fuel efficiency\'...
           'Hull and propeller performance\Vessels\Euronav\Scripts\'...
           'DryDockDates.xlsx'];
       objddd = objddd.readFile(ddFileEuronav, 'dd-mm-yyyy');
       
       % Load standard wind coefficients
       windFile = ['C:\Users\damcl\OneDrive - Hempel Group\Documents\'...
           'Ship Data\Wind\ISO15016\Insert_ISO15016_Wind_Data.m'];
       run(windFile);
