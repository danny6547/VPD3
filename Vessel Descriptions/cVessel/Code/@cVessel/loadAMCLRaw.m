function [ obj, numWarnings, warnings ] = loadAMCLRaw(obj, filename, varargin)
...
set_sql = [{'Timestamp = STR_TO_DATE(@DateTime_UTC, ''%Y-%m-%d %H:%i'')',...
...
opts = setvartype(opts, 18, 'double');
opts = setvaropts(opts, 18, 'ThousandsSeparator', ',');
[obj, numWarnings, warnings] = obj.loadXLSX(filename, mainSheet, firstRow, fileColID, fileColName, tab, set_sql, dateTimeFormat_c, [], opts);
end