...
obj.SQL.loadInFile(filename, tab, cols, delim, ignore_s, '', setNull_ch, 'optionally ''"''');

for io = 1:numel(imo)
    
    imo_ch = num2str( imo(io) );
    obj.SQL.call('insertFromForceSeaReportsIntoRaw', imo_ch);
end
