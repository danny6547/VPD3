...
delimiter_ch = ';';
ignore_ch = 1;
set_ch = [' SET `start` = nullif(str_to_date(@`start`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`xEnd` = nullif(str_to_date(@`xEnd`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`report_end_utc` = nullif(str_to_date(@`report_end_utc`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`report_start_utc` = nullif(str_to_date(@`report_start_utc`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`lat_t1` = nullif(str_to_date(@`lat_t1`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`lat_t2` = nullif(str_to_date(@`lat_t2`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`lon_t1` = nullif(str_to_date(@`lon_t1`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`lon_t2` = nullif(str_to_date(@`lon_t2`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`sog_t1` = nullif(str_to_date(@`sog_t1`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`sog_t2` = nullif(str_to_date(@`sog_t2`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`cog_t1` = nullif(str_to_date(@`cog_t1`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`cog_t2` = nullif(str_to_date(@`cog_t2`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`stw_t1` = nullif(str_to_date(@`stw_t1`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`stw_t2` = nullif(str_to_date(@`stw_t2`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`hdt_t1` = nullif(str_to_date(@`hdt_t1`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`hdt_t2` = nullif(str_to_date(@`hdt_t2`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`wins_t1` = nullif(str_to_date(@`wins_t1`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`wins_t2` = nullif(str_to_date(@`wins_t2`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`airt_t1` = nullif(str_to_date(@`airt_t1`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`airt_t2` = nullif(str_to_date(@`airt_t2`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`airp_t1` = nullif(str_to_date(@`airp_t1`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`airp_t2` = nullif(str_to_date(@`airp_t2`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`rot_t1` = nullif(str_to_date(@`rot_t1`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`rot_t2` = nullif(str_to_date(@`rot_t2`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`rud_t1` = nullif(str_to_date(@`rud_t1`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`rud_t2` = nullif(str_to_date(@`rud_t2`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`pitch_t1` = nullif(str_to_date(@`pitch_t1`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`pitch_t2` = nullif(str_to_date(@`pitch_t2`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`roll_t1` = nullif(str_to_date(@`roll_t1`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`roll_t2` = nullif(str_to_date(@`roll_t2`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`dpt_t1` = nullif(str_to_date(@`dpt_t1`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`dpt_t2` = nullif(str_to_date(@`dpt_t2`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`spow_t1` = nullif(str_to_date(@`spow_t1`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`spow_t2` = nullif(str_to_date(@`spow_t2`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`srpm_t1` = nullif(str_to_date(@`srpm_t1`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`srpm_t2` = nullif(str_to_date(@`srpm_t2`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`strq_t1` = nullif(str_to_date(@`strq_t1`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`strq_t2` = nullif(str_to_date(@`strq_t2`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`sthr_t1` = nullif(str_to_date(@`sthr_t1`, ''%d-%m-%Y %H:%i:%s''), ''''), ',...
    '`sthr_t2` = nullif(str_to_date(@`sthr_t2`, ''%d-%m-%Y %H:%i:%s''), '''')',...
    ];
setnull_c = {...
', `lat_N` = nullif(@`lat_N`,''''),'                                                                                                       
...
'`report_start_utc` = nullif(@`report_start_utc`,''''),'                                                                                 
'`report_end_utc` = nullif(@`report_end_utc`,''''),'                                                                                     
