...
DROP PROCEDURE IF EXISTS DNVGLPerformanceData;

delimiter //

CREATE PROCEDURE DNVGLPerformanceData(imo INT(7), ddi INT, OUT intervalStart DATETIME, OUT intervalEnd DATETIME, OUT ddinterval INT)
proc_label:BEGIN
