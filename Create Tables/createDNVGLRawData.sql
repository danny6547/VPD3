/* Create table for data required by ISO 19030 analysis for DNVGL database*/



DROP PROCEDURE IF EXISTS createDNVGLRawData;

delimiter //

CREATE PROCEDURE createDNVGLRawData()
...
CREATE TABLE rawdata (Raw_Data_Id INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
                         ...
                         CONSTRAINT UniqueVesselDate UNIQUE(IMO_Vessel_Number, DateTime_UTC)
                         /*,
