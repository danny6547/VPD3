...
CALL `inservice`.IMOStartEnd(@imo, @startd, @endd);
INSERT INTO `inservice`.Analysis (IMO_Vessel_Number, StartDate, EndDate, FrequencySufficient, SpeedPowerInRange, SFOCInRange, Comment)
...
/* Apply filters */
CALL `inservice`.applyFilters(SpeedPower_Below, SpeedPower_Above, SpeedPower_Trim, SpeedPower_Disp, Reference_Seawater_Temp,
