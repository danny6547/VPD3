...
BEGIN
	...
	DROP TABLE IF EXISTS del10Mins;
	/* CREATE TABLE del10Mins LIKE mu10Mins; */
    
	CREATE TABLE del10Mins (
							id INT PRIMARY KEY AUTO_INCREMENT,
	...
	INSERT INTO del10Mins (DateTime_UTC,
							Speed_Over_Ground, 
							Relative_Wind_Speed, 
							Shaft_Revolutions, 
							Water_Depth, 
	...
	CREATE TABLE erfc10Mins (id INT PRIMARY KEY AUTO_INCREMENT,
								 ...
								 x_Static_Draught_Fore DOUBLE(10, 5),
								 x_Static_Draught_Aft DOUBLE(10, 5),
								 ...
								 t_Static_Draught_Fore DOUBLE(10, 5),
								 t_Static_Draught_Aft DOUBLE(10, 5),
								 N INT);
	set @p  := 0.3275911;
	SET @ROOT2 := SQRT(2);
	...
	INSERT INTO ChauvenetTempFilter (Speed_Through_Water,
									Delivered_Power,
									Shaft_Revolutions,
									Relative_Wind_Speed, 
									Relative_Wind_Direction, 
